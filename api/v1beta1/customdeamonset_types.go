...
type CustomDeamonsetSpec struct {
...
type CustomDeamonset struct {
	metav1.TypeMeta   `json:",inline"`
	metav1.ObjectMeta `json:"metadata,omitempty"`

	Spec   CustomDeamonsetSpec   `json:"spec,omitempty"`
	Status CustomDeamonsetStatus `json:"status,omitempty"`
}

//+kubebuilder:object:root=true

// CustomDeamonsetList contains a list of CustomDeamonset
type CustomDeamonsetList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []CustomDeamonset `json:"items"`
}

func init() {
	SchemeBuilder.Register(&CustomDeamonset{}, &CustomDeamonsetList{})
}
